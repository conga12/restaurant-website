...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) {
        ...
        try {
            ...
            Set authorities = new HashSet<>(oAuth2User.getAuthorities());
    ...
    private  User processOAuth2User(OAuth2User oAuth2User) {
        ...
        if ("register".equals(mode)) {
            if (existingUser != null) {
                throw new OAuth2ValidationException("Email này đã được đăng ký! Vui lòng sử dụng email khác hoặc đăng nhập.", "REGISTER_EMAIL_EXISTS");
            }
            ...
            if (existingUser == null) {
                throw new OAuth2ValidationException("Email này chưa đăng ký. Vui lòng đăng ký tài khoản trước!", "LOGIN_EMAIL_NOT_FOUND");
            }
